let addedDo = ` <div style="background-color: beige;padding: 0%;border: solid 1px silver;margin-top:2%" class="col-sm-12">
                                    ...
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" id="usr" v-model='value'>
                                                <br>
...
Vue.component('to-do-list', {
    ...
    methods:{
        move(){
            ...
            this.$emit('moved',this.getOther,this.position,this.value)
        }
    }
